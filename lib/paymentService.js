...
//      proposal = contribution.proposalRef;
    ...
    //  console.log(`saved campaign: ${_.inspect(result)}`);
      const proposalId = contribution.proposalRef._id;
      return ProposalService.updateCampaignStatus(proposalId, amount);
    }).then((result) => {
      console.log(`clearCampaignStatusCache: ${_.inspect(result)}`);
