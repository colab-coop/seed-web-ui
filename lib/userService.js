...
function sendWelcomeEmail(user) {
  ...
  const link = `${mailer.rootUrl()}/completeSignup/${user._id}`;  //todo: use a unique temp key like the reset password flow
  ...
  return mailer.sendEmail({
    to: user.email,
    subject: 'Thank You, ' + user.firstName + ' for your support!',
    text: email,
    html: htmlEmail
  });
}
